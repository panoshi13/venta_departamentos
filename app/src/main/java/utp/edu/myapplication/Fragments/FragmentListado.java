...
import utp.edu.myapplication.Adaptador.Adaptador;
...
public class FragmentListado extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recy = view.findViewById(R.id.recycler);
        departamentoDAO = new departamentoDAO(getContext());
        departamentoDAO.abrirConexion();
        adaptador = new Adaptador(departamentoDAO.listado());
